export const independenceQuestions = {
  questions: [
    {
      question: "Independencia en el Baño:", // bd: independucha
      choices: [
    ...
    {
      question: "Independencia en el Vestido", // bd: indepenvestido
      choices: [
    ...
    {
      question: "independencia en la Alimentación", // bd: indepenalimentacion
      choices: [
    ...
    {
      question: "independencia para Dormir", // bd: independormir
      choices: [
