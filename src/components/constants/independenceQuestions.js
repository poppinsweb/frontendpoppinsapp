export const independenceQuestions = {
  questions: [
    {
      question: "Independencia en el Baño:", // bd: independencia_ducha
      choices: [
    ...
    {
      question: "Independencia en el Vestido", // bd: independencia_vestido
      choices: [
    ...
    {
      question: "independencia en la Alimentación", // bd: independencia_alimentacion
      choices: [
    ...
    {
      question: "independencia para Dormir", // bd: indepencia_dormir
      choices: [
