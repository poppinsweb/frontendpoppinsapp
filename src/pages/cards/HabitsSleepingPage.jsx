...
const HabitsSleepingPage = () => {
  const { data: questionsData, loading, error } = useFetchData('http://localhost:3000/evaluations/habitssleeping');
...
export default HabitsSleepingPage;
